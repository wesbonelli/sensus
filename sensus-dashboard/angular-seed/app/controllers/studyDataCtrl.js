...
angular.module('SensusPortal.studyDataCtrl', ['ngRoute'])

.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/study_data', {
    templateUrl: 'views/study_data.html',
    controller: 'studyDataCtrl'
  });
}])

.controller('studyDataCtrl', function($scope, $http, $location, $route) {
